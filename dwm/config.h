...
#if BAR_PANGO_PATCH
static const char font[]                 = "iosevka-term-bold 30";
#else
static const char *fonts[]               = { "jetbrainsmononerdfont-medium:size=15" };
#endif // BAR_PANGO_PATCH
static const char dmenufont[]            = "jetbrainsmononerdfont-medium:size=15";
...
static const char *backlightdown[] = { "/usr/bin/light", "-U", "10", NULL };
static const char *backlightup[] = { "/usr/bin/light", "-A", "10", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_F7, spawn, SHCMD("xinput disable 12 & xinput disable 13 & unclutter -idle 0") },
	{ MODKEY,                       XK_F8, spawn, SHCMD("xinput enable 12 & xinput enable 13") },
	{ MODKEY,                       XK_q, spawn, SHCMD("slock & loginctl suspend") },
